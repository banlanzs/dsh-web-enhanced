...
export async function mentionOptions(
  ...
  if (workspaceId === undefined) throw new Error('this session belongs to no project')
 ...
 */
export function applyMention(deps: MentionDeps, sessionId: string, path: string): void {
