...
export const en: Record<keyof typeof zh, string> = {
  ...
  'terminal.expand': 'Show terminal',
  'terminal.collapse': 'Hide terminal',
  'terminal.new': 'New terminal',
  'terminal.close': 'Close terminal',
  'terminal.resize': 'Drag to resize the terminal',
  'terminal.empty': 'No terminal yet — press “+” to open one',
  'terminal.connecting': 'Connecting…',
  'terminal.reconnecting': 'Connection lost, reconnecting…',
  'terminal.exited': 'Process exited ({code})',
  'terminal.gone': 'This terminal no longer exists',
