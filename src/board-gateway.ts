 ...
 */
function runDeps(ctx: Context): RunDeps {
...
export function boardDeps(deps: BoardDomainDeps): BoardDeps {
  return {
    ...runDeps(deps.ctx),
 ...
 */
export function createBoardDomain(deps: BoardDomainDeps): TaskBoard {
