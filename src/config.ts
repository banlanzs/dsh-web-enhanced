...
import { boardConfigFragment, resolveBoardConfig } from './board.ts'
import type { BoardConfigInput } from './board.ts'
import { filesConfigFragment, resolveFilesConfig } from './files-gateway.ts'
import type { FilesConfigInput } from './files-gateway.ts'
import { gitConfigFragment, resolveGitConfig } from './git-gateway.ts'
import type { GitConfigInput } from './git-gateway.ts'
import { modelConfigFragment, resolveModelConfig } from './model-gateway.ts'
import type { ModelConfigInput } from './model-gateway.ts'
import { pluginsConfigFragment, resolvePluginsConfig } from './plugins-gateway.ts'
import type { PluginsConfigInput } from './plugins-gateway.ts'
import { visionConfigFragment, resolveVisionConfig } from './vision-gateway.ts'
import type { VisionConfigInput } from './vision-gateway.ts'

/** Plugin config; every bound defaults when unset. */
export interface Config
  extends BoardConfigInput, ModelConfigInput, FilesConfigInput, GitConfigInput,
  PluginsConfigInput, VisionConfigInput {}
