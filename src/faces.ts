 ...
 */
export function settingsFace(ctx: Context): SettingsVisionFace | undefined {
  return ctx.get('settings' as never, false) as unknown as SettingsVisionFace | undefined
}
