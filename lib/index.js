	...
	*/
	...
	async fetchBalance(now) {
		...
		if (key === void 0 || key.trim() === "") return {
			...
			error: {
				code: "no-api-key",
				message: `environment variable ${this.config.apiKeyEnv} is not set`
			}
		};
		let response;
		try {
...
const taskRecordSchema = z$1.object({
	id: z$1.string(),
	...
	cron: z$1.string().nullable(),
	nextRunAt: z$1.number().nullable(),
	workspaceId: z$1.string().nullable(),
	sessionId: z$1.string().nullable(),
	result: z$1.object({
		reasonKind: z$1.enum([
			"completed",
			"error",
...
const Config = z.object({
	cronIntervalMs: z.number().default(3e4),
	balanceApiKeyEnv: z.string().default("DEEPSEEK_API_KEY"),
	balanceCacheTtlMs: z.number().default(6e4),
	balanceBaseUrl: z.string().default("https://api.deepseek.com"),
	skipDirs: z.array(z.string()).default(["node_modules"]),
	readMaxBytes: z.number().default(1048576),
	writeMaxBytes: z.number().default(2097152),
	binaryMaxBytes: z.number().default(5242880),
	gitOutputMaxBytes: z.number().default(262144),
	gitMaxCount: z.number().default(100),
	searchMaxDepth: z.number().default(8),
	searchMaxEntries: z.number().default(200),
	officeMaxBytes: z.number().default(5242880)
});
