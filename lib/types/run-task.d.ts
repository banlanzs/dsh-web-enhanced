...
export interface RunDeps {
     ...
     */
    readonly attachWorkspaceSession: ((workspaceId: WorkspaceId, sessionId: SessionId) => Promise<void>) | undefined;
}
 ...
 */
export declare function createTaskAgent(deps: RunDeps, target: RunTarget): Promise<{
    agent: Agent;
    sessionId: SessionId;
}>;
/**
