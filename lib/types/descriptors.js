...
const deepseekRateViewSchema = z.object({
    model: z.string(),
    mode: z.enum(['peak-valley', 'flat', 'unknown']),
    period: z.enum(['peak', 'offpeak', 'flat']),
...
const opencodeGoWindowSchema = z.object({
    key: z.enum(['five_hour', 'seven_day', 'monthly']),
...
const visionStatusSchema = z.object({
    ...
    apiKeySource: z.enum(['config', 'env', 'none-needed', 'unset']),
...
export const WEB_ENHANCED_DESCRIPTORS = [
