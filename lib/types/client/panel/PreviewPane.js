...
import { dataUrlOf, extensionOf, hasRenderedForm, isEditable, mimeOfImagePath } from "../preview.js";
...
function MarkdownView({ source, image }) {
    return (_jsx("div", { className: css.markdown, children: _jsx(Blocks, { blocks: parseMarkdown(source), image: image }) }));
}
