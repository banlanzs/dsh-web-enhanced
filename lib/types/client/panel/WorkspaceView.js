...
export function WorkspaceView(props) {
    ...
    _jsxs("section", { className: css.view, "data-testid": "workspace-view", "data-conversation-composer-overlay": "", children: [_jsx("nav", { className: css.tabs, role: "tablist", children: TABS.map(entry => (_jsx("button", { type: "button", role: "tab", className: css.tab, "data-active": tab === entry.tab || undefined, "aria-selected": tab === entry.tab, "data-testid": `workspace-view-tab-${entry.tab}`, onClick: () => { selectTab(entry.tab); }, children: t(entry.key) }, entry.tab))) }), _jsxs("div", { className: css.body, role: "tabpanel", children: [tab === 'explorer' && (_jsxs("div", { className: sidebarCollapsed ? css.explorerCollapsed : css.explorer, "data-testid": "workspace-explorer", "data-sidebar": sidebarCollapsed ? 'collapsed' : 'expanded', children: [sidebarCollapsed
                                ...
                                : (_jsxs("aside", { className: css.sidebar, children: [_jsx("button", { type: "button", className: css.collapse, "aria-label": t('files.collapse'), "data-testid": "workspace-sidebar-collapse", title: t('files.collapse'), onClick: () => { setSidebarCollapsed(true); }, children: _jsx("span", { "aria-hidden": "true", children: "\u2039" }) }), _jsx(FileTree, { ...props, workspaceId: String(workspaceId) })] })), _jsx(PreviewPane, { ...props, workspaceId: String(workspaceId) })] })), tab === 'scm' && _jsx(ScmPane, { ...props, workspaceId: String(workspaceId) }), tab === 'board' && (_jsx(BoardPanel, { remote: props.remote, workspaces: workspaces.items, openSession: props.openSession, t: t })), tab === 'graph' && (_jsx("div", { className: css.graph, children: _jsx(GraphPanel, { workspaceId: String(workspaceId), remote: props.remote, t: t }) }))] })] }));
}
