...
export function WorkspaceView(props) {
    ...
    return (_jsxs("section", { className: css.view, "data-testid": "workspace-view", children: [_jsx("nav", { className: css.tabs, role: "tablist", children: TABS.map(entry => (_jsx("button", { type: "button", role: "tab", className: css.tab, "data-active": tab === entry.tab || undefined, "aria-selected": tab === entry.tab, "data-testid": `workspace-view-tab-${entry.tab}`, onClick: () => { selectTab(entry.tab); }, children: t(entry.key) }, entry.tab))) }), _jsxs("div", { className: css.body, role: "tabpanel", children: [tab === 'explorer' && (_jsxs("div", { className: css.explorer, "data-testid": "workspace-explorer", children: [_jsx("aside", { className: css.sidebar, children: _jsx(FileTree, { ...props, workspaceId: String(workspaceId) }) }), _jsx(PreviewPane, { ...props, workspaceId: String(workspaceId) })] })), tab === 'scm' && _jsx(ScmPane, { ...props, workspaceId: String(workspaceId) }), tab === 'board' && (_jsx(BoardPanel, { remote: props.remote, workspaces: workspaces.items, openSession: props.openSession, t: t })), tab === 'graph' && (_jsx(GraphPanel, { workspaceId: String(workspaceId), remote: props.remote, t: t }))] })] }));
}
