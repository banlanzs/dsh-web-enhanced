...
/** The file tree. */
export function FileTree({ workspaceId, usePanel, remote, toggleExpanded, setQuery, openTab, t, onCollapse, collapseLabel, }) {
    ...
    return (_jsxs("div", { className: css.tree, "data-testid": "file-tree", children: [_jsxs("div", { className: css.searchRow, children: [_jsx("input", { className: css.search, value: query, placeholder: t('files.search'), "aria-label": t('files.search'), "data-testid": "file-tree-search", onChange: event => { setQuery(event.target.value); } }), onCollapse !== undefined && (_jsx("button", { type: "button", className: css.collapse, "aria-label": collapseLabel ?? '', title: collapseLabel, "data-testid": "workspace-sidebar-collapse", onClick: onCollapse, children: _jsx("span", { "aria-hidden": "true", children: "\u2039" }) }))] }), matches !== null
