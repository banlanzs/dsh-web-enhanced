...
export type { ApiError, BalanceGetRequest, BalanceInfo, BalanceView, DeepSeekRateGetRequest, DeepSeekRateGetResult, DeepSeekRateView, DeepSeekRateWindow, FsBrowseEntry, FsBrowseRequest, FsBrowseResult, FsBrowseView, FsDeleteRequest, FsEntryView, FsListRequest, FsListResult, FsOfficePreviewRequest, FsOfficePreviewResult, FsReadRequest, FsReadResult, FsSearchRequest, FsSearchResult, FsWriteRequest, FsWriteResult, GitBranchView, GitBranchesRequest, GitBranchesResult, GitCheckoutRequest, GitCheckoutResult, GitCommitDetailView, GitCommitFileView, GitCommitRequest, GitCommitResult, GitCommitView, GitCommitDiffRequest, GitCommitDiffResult, GitDiffRequest, GitDiffResult, GitLogRequest, GitLogResult, GitMutateRequest, GitMutateResult, GitStatusEntry, GitStatusRequest, GitStatusResult, GitWorkingFileView, GitWorkingRequest, GitWorkingResult, GitWorkingState, GitWorkingView, GlobalPromptConfigView, GlobalPromptGetResult, GlobalPromptSaveRequest, GlobalPromptSaveView, GlobalPromptSetResult, ModelRetryConfigView, ModelRetryGetResult, ModelRetrySetRequest, ModelRetrySetResult, ModelRouteDescribeRequest, ModelRouteDescribeResult, ModelRouteDescribeView, OpencodeGoUsageView, OpencodeGoWindow, OfficeBlock, OfficeKind, PluginListRequest, PluginListResult, PluginListView, PluginMutateRequest, PluginMutateResult, PluginMutateView, PluginView, MemoryConfigGetResult, MemoryConfigSaveRequest, MemoryConfigSetResult, MemoryConfigView, MemoryDeleteRequest, MemoryDeleteResult, MemoryKind, MemoryListRequest, MemoryListResult, MemoryRecord, ModelPricingView, PricingGetRequest, PricingGetResult, PricingView, TaskCreateRequest, TaskCreateResult, TaskListResult, TaskRecord, TaskRemoveRequest, TaskRemoveResult, TaskRunRequest, TaskRunResult, TaskStatus, TaskUpdateRequest, TaskUpdateResult, VisionAttemptFailureView, VisionConfigGetResult, VisionConfigPatch, VisionConfigSaveRequest, VisionConfigSaveView, VisionConfigSetResult, VisionConfigView, VisionEndpointModelView, VisionEndpointModelsRequest, VisionEndpointModelsResult, VisionEndpointModelsView, VisionHarnessModelView, VisionModelOptionView, VisionProviderOptionView, VisionStatusResult, VisionStatusView, TerminalCloseRequest, TerminalCloseResult, TerminalListRequest, TerminalListResult, TerminalSignalName, TerminalSignalRequest, TerminalSignalResult, TerminalSpawnRequest, TerminalSpawnResult, TerminalView, } from '../types.ts';
/**
 ...
 */
export type PreviewKind = 'markdown' | 'html' | 'code' | 'diff' | 'csv' | 'pdf' | 'office' | 'image' | 'text';
 ...
 */
export type WebEnhancedProps<K extends keyof SlotMap & string> = PropsRuntime<K> & WebEnhancedInjected & PropsLocale<'webEnhanced'>;
