...
function DeepSeekLine({ view, pricing, rate, names, provider, model, usage, busy, now, fatal, t, onRefresh, }) {
    ...
    if (fatal !== null) {
        ...
        groups.push(_jsxs("span", { className: css.group, title: title, children: [t('balance.title'), ' ', _jsx("b", { className: css.num, children: formatBalanceAmount(info.currency, info.totalBalance) }), low
