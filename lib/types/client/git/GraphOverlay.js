...
export function GraphPanel({ workspaceId, remote, t }) {
...
export function GraphOverlay({ useOverlay, useSessions, useWorkspaces, remote, closeOverlay, t, }) {
    ...
    if (!open)
        return null;
    return (_jsx(OverlayShell, { title: t('graph.title'), closeLabel: t('graph.close'), onClose: closeOverlay, testId: "graph-overlay", fill: true, children: _jsx(GraphPanel, { workspaceId: workspaceId === undefined ? undefined : String(workspaceId), remote: remote, t: t }) }));
}
