...
export declare const zh: {
    ...
    readonly 'vision.form.harnessHint': "从 DSH 已配置的渠道里选；选「自动检测」时依次尝试所有声明支持图片的模型。";
    readonly 'vision.form.provider': "渠道";
    readonly 'vision.form.providerAuto': "自动检测";
    readonly 'vision.form.model': "模型";
    readonly 'vision.form.modelHint': "只列出声明支持图片的模型";
