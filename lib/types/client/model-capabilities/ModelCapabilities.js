...
import { applyDraft, applyReasoningToAll, cloneRecord, DEEPSEEK_NS, draftAt, isRecord, MODALITIES, normalizePiAiDraft, PI_AI_NS, recordOf, THINKING_LEVELS, usableReasoningPreset, validateDeepSeekDraft, validatePiAiDraft, } from "./settings-draft.js";
...
function reasoningSummary(value, t) {
    if (value === false)
        return t('modelCapabilities.reasoningNone');
    if (isRecord(value)) {
...
function ReasoningEditor({ value, onChange, disabled, t }) {
    ...
    return (_jsxs("div", { className: css.reasoningEditor, children: [_jsxs("select", { className: css.select, value: mode, disabled: disabled, "aria-label": t('modelCapabilities.reasoning'), onChange: (event) => { setMode(event.target.value); }, children: [_jsx("option", { value: "none", children: t('modelCapabilities.reasoningNone') }), _jsx("option", { value: "custom", children: t('modelCapabilities.reasoningCustom') })] }), mode === 'custom'
...
function PiAiCapabilitiesCardBody({ entry, namespace, catalog, api, t, readOnly, coordinatedRevision, onApplied, onReloadRequested, }) {
    ...
    const [presetReasoning, setPresetReasoning] = useState(undefined);
    const disabled = readOnly || busy;
    ...
    return (_jsxs("details", { className: css.card, open: configured || entry.active, children: [_jsxs("summary", { className: css.summary, children: [_jsx("span", { className: css.cardTitle, children: entry.displayName }), _jsx("span", { className: css.cardRoute, children: entry.provider })] }), _jsxs("div", { className: css.cardBody, children: [_jsxs("section", { className: css.section, "aria-label": t('modelCapabilities.routeSection'), children: [_jsx("h3", { className: css.sectionTitle, children: t('modelCapabilities.routeSection') }), _jsxs("div", { className: css.field, children: [_jsxs("div", { className: css.fieldHead, children: [_jsx("span", { className: css.fieldLabel, children: t('modelCapabilities.defaultInput') }), _jsx("span", { className: css.fieldHint, children: t('modelCapabilities.defaultInputHint') })] }), _jsx(InputEditor, { value: draft['defaultInput'], onChange: (value) => { setField('defaultInput', value); }, disabled: disabled, required: true, t: t })] }), _jsxs("label", { className: css.field, children: [_jsx("span", { className: css.fieldLabel, children: t('modelCapabilities.routeReasoning') }), _jsxs("select", { className: css.select, value: stringAt('reasoning') ?? '', disabled: disabled, onChange: (event) => { setField('reasoning', event.target.value === '' ? undefined : event.target.value); }, children: [_jsx("option", { value: "", children: t('modelCapabilities.routeReasoningInherit') }), THINKING_LEVELS.map(level => (_jsx("option", { value: level, children: t(LEVEL_KEYS[level]) }, level)))] }), _jsx("p", { className: css.fieldHint, children: t('modelCapabilities.routeReasoningHint') })] }), _jsxs("div", { className: css.field, children: [_jsxs("div", { className: css.fieldHead, children: [_jsx("span", { className: css.fieldLabel, children: t('modelCapabilities.reasoningPreset') }), _jsx("span", { className: css.fieldHint, children: t('modelCapabilities.reasoningPresetHint') })] }), _jsx(ReasoningEditor, { value: presetReasoning, onChange: setPresetReasoning, disabled: disabled, t: t }), _jsx("button", { type: "button", className: css.button, disabled: disabled || !usableReasoningPreset(presetReasoning), onClick: applyPresetToAll, children: t('modelCapabilities.reasoningApplyAll') })] })] }), _jsxs("section", { className: css.section, "aria-label": t('modelCapabilities.modelSection'), children: [_jsxs("div", { className: css.modelHead, children: [_jsx("h3", { className: css.sectionTitle, children: t('modelCapabilities.modelSection') }), _jsx("span", { className: css.fieldHint, children: listMode
                                ...
                                ? (_jsx("div", { className: css.modelList, children: models.map((model, index) => {
                                        ...
                                        return (_jsxs("div", { className: css.modelRow, children: [_jsxs("div", { className: css.modelHead, children: [_jsx("span", { className: css.modelId, children: id }), typeof entry['name'] === 'string' && entry['name'].length > 0
                                                            ...
                                                            : null] }), _jsxs("label", { className: css.field, children: [_jsx("span", { className: css.fieldLabel, children: t('modelCapabilities.modelInput') }), _jsx(InputEditor, { value: entry['input'], onChange: (value) => { patchListEntry(index, 'input', value); }, disabled: disabled, t: t })] }), _jsxs("details", { className: css.reasoningDisclosure, children: [_jsxs("summary", { className: css.reasoningSummary, children: [_jsx("span", { children: t('modelCapabilities.reasoning') }), _jsx("span", { className: css.reasoningSummaryValue, children: reasoningSummary(entry['reasoningEfforts'], t) })] }), _jsx("div", { className: css.reasoningBody, children: _jsx(ReasoningEditor, { value: entry['reasoningEfforts'], onChange: (value) => { patchListEntry(index, 'reasoningEfforts', value); }, disabled: disabled, t: t }) })] })] }, index));
                                    }) }))
