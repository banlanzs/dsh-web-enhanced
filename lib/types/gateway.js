...
import { deepseekRateFor } from "./deepseek-rate.js";
...
import { createTerminalRegistry } from "./terminal.js";
import { applyTerminalSocket } from "./terminal-socket.js";
import { ModelRouteNames } from "./model-names.js";
import { OpencodeGoUsageClient } from "./opencode-go.js";
...
import { GLOBAL_PROMPT_MAX_CHARS, GLOBAL_PROMPT_SETTINGS_NS, MEMORY_SETTINGS_NS } from "./types.js";
/** Settings namespaces whose route-level retry policy the model-retry remotes edit. */
const MODEL_RETRY_NAMESPACES = new Set(['llm-deepseek', 'llm-pi-ai']);
/**
...
function retryConfigurableEntries(llm) {
    ...
    return llm.listConfigurableProviders().filter(entry => MODEL_RETRY_NAMESPACES.has(entry.settingsNs)
...
let WebEnhancedGateway = (() => {
    ...
    return class WebEnhancedGateway extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _terminalSpawn_decorators, { kind: "method", name: "terminalSpawn", static: false, private: false, access: { has: obj => "terminalSpawn" in obj, get: obj => obj.terminalSpawn }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async modelRetrySet(request) {
            try {
                ...
                await settings.update(entry.settingsNs, nestAt(entry.settingsPath, {
        ...
        async memoryDelete(request) {
            try {
                ...
                const removed = await this.memoryStore.delete(id);
                return { removed };
            }
            catch (error) {
        ...
        async fsSearch(request) {
            ...
            try {
                ...
                if (cacheable)
                    this.storeEmptySearch(key, result);
                return result;
            }
            catch (error) {
